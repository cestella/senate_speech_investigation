...
def run(infile="topics_pts", dim=350, perplexity=20.0, outfile="topics_2d"):
    X = Math.loadtxt(infile, delimiter=",")
    Y = tsne(X, 2, dim, perplexity, False)
...
if __name__ == "__main__":
    ...
    proj_out = sys.argv[4]
    run(points, dim, perplexity, proj_out)
